...
/**
 * Configuration for Coordinator Service and rss-cluster, including service port, heartbeat
 * interval, etc.
 */
public class CoordinatorConf extends RssBaseConf {
  ...
  public static final ConfigOption<Long> COORDINATOR_EXCLUDE_NODES_CHECK_INTERVAL =
      ConfigOptions.key("rss.coordinator.exclude.nodes.check.interval.ms")
          .longType()
  ...
  public static final ConfigOption<Long> COORDINATOR_NODES_PERIODIC_OUTPUT_INTERVAL_TIMES =
      ConfigOptions.key("rss.coordinator.server.periodic.output.interval.times")
          .longType()
          .checkValue(
              ConfigUtils.POSITIVE_LONG_VALIDATOR,
              "output server list interval times must be positive")
          .defaultValue(30L)
          .withDescription(
              "The periodic interval times of output alive nodes. The interval sec can be calculated by ("
                  + COORDINATOR_HEARTBEAT_TIMEOUT.key()
                  + "/3 * rss.coordinator.server.periodic.output.interval.times)");
  public static final ConfigOption<AssignmentStrategyFactory.StrategyName>
      COORDINATOR_ASSIGNMENT_STRATEGY =
          ConfigOptions.key("rss.coordinator.assignment.strategy")
  ...
  public static final ConfigOption<Long> COORDINATOR_APP_EXPIRED =
      ConfigOptions.key("rss.coordinator.app.expired")
          .longType()
          .defaultValue(60 * 1000L)
          .withDescription(
              "Application expired time (ms), the heartbeat interval must be less than it");
  public static final ConfigOption<Integer> COORDINATOR_SHUFFLE_NODES_MAX =
      ConfigOptions.key("rss.coordinator.shuffle.nodes.max")
          .intType()
          .defaultValue(9)
  ...
  public static final ConfigOption<List<String>> COORDINATOR_ACCESS_CHECKERS =
      ConfigOptions.key("rss.coordinator.access.checkers")
          .stringType()
          .asList()
          .defaultValues(
  ...
  public static final ConfigOption<Integer> COORDINATOR_ACCESS_CANDIDATES_UPDATE_INTERVAL_SEC =
      ConfigOptions.key("rss.coordinator.access.candidates.updateIntervalSec")
          .intType()
          .checkValue(
              ConfigUtils.POSITIVE_INTEGER_VALIDATOR_2,
              "access candidates update interval must be positive")
          .defaultValue(120)
  ...
  public static final ConfigOption<String> COORDINATOR_ACCESS_CANDIDATES_PATH =
      ConfigOptions.key("rss.coordinator.access.candidates.path")
          .stringType()
          .noDefaultValue()
          .withDescription("Accessed candidates file path");
  public static final ConfigOption<Double> COORDINATOR_ACCESS_LOADCHECKER_MEMORY_PERCENTAGE =
      ConfigOptions.key("rss.coordinator.access.loadChecker.memory.percentage")
          .doubleType()
          .checkValue(
  ...
  public static final ConfigOption<Integer> COORDINATOR_ACCESS_LOADCHECKER_SERVER_NUM_THRESHOLD =
      ConfigOptions.key("rss.coordinator.access.loadChecker.serverNum.threshold")
          .intType()
          .checkValue(
              ConfigUtils.POSITIVE_INTEGER_VALIDATOR_2,
              "load checker serverNum threshold must be positive")
          .noDefaultValue()
          .withDescription(
  ...
  public static final ConfigOption<Boolean> COORDINATOR_DYNAMIC_CLIENT_CONF_ENABLED =
      ConfigOptions.key("rss.coordinator.dynamicClientConf.enabled")
          .booleanType()
          .defaultValue(false)
          .withDescription("enable dynamic client conf");
  public static final ConfigOption<String> COORDINATOR_DYNAMIC_CLIENT_CONF_PATH =
      ConfigOptions.key("rss.coordinator.dynamicClientConf.path")
          .stringType()
          .noDefaultValue()
  ...
  public static final ConfigOption<Integer> COORDINATOR_DYNAMIC_CLIENT_CONF_UPDATE_INTERVAL_SEC =
      ConfigOptions.key("rss.coordinator.dynamicClientConf.updateIntervalSec")
          .intType()
          .checkValue(
              ConfigUtils.POSITIVE_INTEGER_VALIDATOR_2,
              "dynamic client conf update interval in seconds")
          .defaultValue(120)
          .withDescription("The dynamic client conf update interval in seconds");
  public static final ConfigOption<String> COORDINATOR_REMOTE_STORAGE_CLUSTER_CONF =
      ConfigOptions.key("rss.coordinator.remote.storage.cluster.conf")
          .stringType()
          .noDefaultValue()
          .withDescription(
  ...
  public static final ConfigOption<Long> COORDINATOR_REMOTE_STORAGE_SCHEDULE_TIME =
      ConfigOptions.key("rss.coordinator.remote.storage.schedule.time")
          .longType()
          .defaultValue(60 * 1000L)
          .withDescription(
              "The time of scheduling the read and write time of the paths to obtain different Hadoop FS");
  public static final ConfigOption<Integer> COORDINATOR_REMOTE_STORAGE_SCHEDULE_FILE_SIZE =
      ConfigOptions.key("rss.coordinator.remote.storage.schedule.file.size")
          .intType()
          .defaultValue(204800 * 1000)
          .withDescription("The size of the file that the scheduled thread reads and writes");
  public static final ConfigOption<Integer> COORDINATOR_REMOTE_STORAGE_SCHEDULE_ACCESS_TIMES =
      ConfigOptions.key("rss.coordinator.remote.storage.schedule.access.times")
          .intType()
          .defaultValue(3)
  ...
  public static final ConfigOption<Boolean> COORDINATOR_START_SILENT_PERIOD_ENABLED =
      ConfigOptions.key("rss.coordinator.startup-silent-period.enabled")
          .booleanType()
          .defaultValue(false)
          .withDescription(
              "Enable the startup-silent-period to reject the assignment requests "
  ...
  public static final ConfigOption<Long> COORDINATOR_START_SILENT_PERIOD_DURATION =
      ConfigOptions.key("rss.coordinator.startup-silent-period.duration")
          .longType()
          .defaultValue(20 * 1000L)
          .withDescription(
              "The waiting duration(ms) when conf of "
                  + COORDINATOR_START_SILENT_PERIOD_ENABLED
                  + " is enabled.");
  ...
  public static final ConfigOption<Long> COORDINATOR_NODES_CLIENT_CACHE_EXPIRED =
      ConfigOptions.key("rss.coordinator.nodes.client.cache.expired")
          .longType()
  ...
  public static final ConfigOption<Integer> COORDINATOR_NODES_CLIENT_CACHE_MAX =
      ConfigOptions.key("rss.coordinator.nodes.client.cache.max")
          .intType()
          .defaultValue(1000)
          .withDescription(
  ...
  public static final ConfigOption<List<String>> COORDINATOR_APP_CONF_SHOW_LIST =
      ConfigOptions.key("rss.coordinator.app.conf.show.list")
          .stringType()
          .asList()
          .defaultValues()
          .withDescription("The list to display for application spark config.");
  public static final ConfigOption<List<String>> COORDINATOR_APP_CONF_EXCLUDE_LIST =
      ConfigOptions.key("rss.coordinator.app.conf.excludeList")
          .stringType()
          .asList()
          .defaultValues()
          .withDescription("Exclude app config list, separated by ','");
