...
public class CommonMetrics {
  ...
  public static <T> void addLabeledCacheGauge(
  ...
  protected static void register(CollectorRegistry collectorRegistry, String tags, RssConf conf) {
    if (!isRegister) {
      CommonMetrics.tags = tags;
