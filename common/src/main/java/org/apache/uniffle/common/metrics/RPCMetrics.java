...
public abstract class RPCMetrics {
  ...
  public static Counter counterRpcExecutionTime;
  public static final String RPC_LABEL = "rpc";
  public static final String RPC_EXECUTION_TIME = "time";
  ...
  public static void registerRpcExecutionCounters(MetricsManager metricsManager) {
    counterRpcExecutionTime =
        metricsManager.addCounter("rpc_execution_time", RPC_LABEL, RPC_EXECUTION_TIME);
  }
}
